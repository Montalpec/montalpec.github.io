/*
    Expedition - Creative Coming Soon HTML5 Template
    Version: 1.0.2
    Author: Mountain-Themes
    Author URL: https://themeforest.net/user/mountain-themes
    Expedition © 2023. Design & Coded by Mountain-Themes.
...
setTimeout(function() {
  $("header .logo").delay(1200).css({display: 'none'}).fadeIn(1200);
...
function mt_video_background() {
  ...
  var options = {
      ...
      mobileFallbackImage: "images/youtube-poster.jpg",
      // Image used as fallback on mobile devices
      coverImage: "images/youtube-poster.jpg",
